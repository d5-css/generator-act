...
*/
    ajax = exports.ajax = function (options) {
        ...
        if (!hasParam && getType(data) !== 'string') {
            delete settings.data;
            data = settings.data;
        }

        if (typeof data === 'object' &&
            getType(data) !== 'formdata') {
            ...
            if (type === 'get') {
                ...
                each(data, function (value, key) {
                    tmp.append(key,
                        getType(value) === 'array' ? value.join() : value);
                });
...
*/
    ...
    function getSuccess(xhr) {
        ...
        return defaults.onSuccess || noop;
    }
});
